...
from apps.staff.models import Position, Center, Department, SubDepartment, Responsibility, CenterManagement, \
    WorkingType, Vacancy
...
class StaffTestCase(APITestCase):
    def setUp(self):
        ...
        self.responsibility2 = Responsibility.objects.create(
            text='<p>asdas</p>',
            type='company'
        )
